...
export class TransactionsModal {
  private sdk: PayCan;
  private options: TransactionsModalOptions;
   ...
   */
  private async loadTransactions(page: number = 1): Promise<void> {
    this.loading = true;
    try {
   ...
   */
  private getTransactionsList(): string {
   ...
   */
  private getTransactionRow(tx: Transaction): string {
