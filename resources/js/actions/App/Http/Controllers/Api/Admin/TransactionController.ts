...
/**
* @see \App\Http\Controllers\Api\Admin\TransactionController::index
* @see app/Http/Controllers/Api/Admin/TransactionController.php:126
...
/**
* @see \App\Http\Controllers\Api\Admin\TransactionController::show
* @see app/Http/Controllers/Api/Admin/TransactionController.php:223
* @route '/api/admin/transactions/{transaction}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/api/admin/transactions/{transaction}',
} satisfies RouteDefinition<["get","head"]>
