            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        PayCan empower apps with full-featured payment system. <br />We suggest starting with the following.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Read the
                                <a
                                    href="https://github.com/paycan-app/paycan"
                                    target="_blank"
                        ...
                        >
                            ...
                            <span>
                                Check out 
                                <a
                                    href="/api/documentation/user"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>User API Swagger</span>
                                    <svg
                                        width="{10}"
                                        height="{11}"
                                        viewBox="0 0 10 11"
                        ...
                        >
                            ...
                            <span>
                                Check out
                                <a
                                    href="/api/documentation/admin"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>Admin API Swagger</span>
                                    <svg
                                        width="{10}"
                                        height="{11}"
                                        viewBox="0 0 10 11"
                ...
                >
                        <img src="/images/p-dark-logo.jpg" alt="Logo"  v-bind="$attrs" />
