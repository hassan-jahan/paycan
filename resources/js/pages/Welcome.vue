            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Paycan allows you integrate current system with any Paymanet . <br />We suggest starting with the following.
                    </p>
                ...
                >
                        <img src="/images/p-dark-logo.jpg" alt="Logo" :class="className" v-bind="$attrs" />
