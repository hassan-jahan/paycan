...
class NotificationSettings extends BaseSettingsPage
{
    ...
    protected static ?string $slug = 'settings/mail/notifications';
    ...
    {
        return [
            app(\App\Services\Settings\Providers\NotificationSettingsProvider::class),
        ];
    }

    public function form(\Filament\Schemas\Schema $schema): \Filament\Schemas\Schema
    {
        $provider = app(\App\Services\Settings\Providers\NotificationSettingsProvider::class);

        return $schema
            ->schema($provider->getSchema()->getComponents())
            ->statePath('data');
    }
